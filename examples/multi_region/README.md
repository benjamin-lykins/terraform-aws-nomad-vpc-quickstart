This example demonstrates deploying the Nomad VPC Quickstart in multiple AWS regions, with user configuration. Make sure CIDRs do not overlap across regions, if looking to peer VPCs in the future and federate Nomad clusters.
